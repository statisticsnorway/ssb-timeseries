...
class Dataset:
    ...
    def search(self, pattern: str | dict = "*", *args, **kwargs):
    ...
    def filter(
        ...
        **kwargs,
        ...
        Args:
            ...
            tags (dict , optional): Dictionary with tags to search for. Defaults to None. All tags in dict must be satisfied for the same series (tags are combined by AND).
